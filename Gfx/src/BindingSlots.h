...
namespace gfx
{
	...
	namespace BindingSlots
	{
		...
		namespace SRV
		{
			...
			constexpr uint32_t CompactedInstances = 5;
		}
		...
		namespace UAV
		{
			...
			constexpr uint32_t MeshVisibleCounts   = 2;
			constexpr uint32_t MeshInstanceOffsets = 3;
			constexpr uint32_t MeshWriteCursor     = 4;
			constexpr uint32_t CompactedInstances  = 5;
