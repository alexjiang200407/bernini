...
AssetImporterDialog::GetOutputs() const
{
	...
	outputs.mesh = File(m_MeshSection, m_MeshName, Project::c_MeshesDirectoryName, c_MeshExtension);
	...
	outputs.materialDir = Folder(m_MaterialSection->GetFolder(), Project::c_MaterialsDirectoryName);
	outputs.textureDir = Folder(m_TextureSection->GetFolder(), Project::c_TexturesSrcDirectoryName);
