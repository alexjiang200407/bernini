...
namespace bgl
{
    ...
    //        format                   name             bytes blk          kind               red   green   blue  alpha  depth  stencl signed  srgb
        ...
        { Format::R8_SNORM,          "R8_SNORM",          1,   1, FormatKind::kNormalized,   true,  false, false, false, false, false, true,  false },
        ...
        { Format::RG8_SNORM,         "RG8_SNORM",         2,   1, FormatKind::kNormalized,   true,  true,  false, false, false, false, true,  false },
        ...
        { Format::R16_SNORM,         "R16_SNORM",         2,   1, FormatKind::kNormalized,   true,  false, false, false, false, false, true,  false },
        ...
        { Format::RGBA8_SNORM,       "RGBA8_SNORM",       4,   1, FormatKind::kNormalized,   true,  true,  true,  true,  false, false, true,  false },
        { Format::BGRA8_UNORM,       "BGRA8_UNORM",       4,   1, FormatKind::kNormalized,   true,  true,  true,  true,  false, false, false, false },
        { Format::BGRX8_UNORM,       "BGRX8_UNORM",       4,   1, FormatKind::kNormalized,   true,  true,  true,  false, false, false, false, false },
        { Format::SRGBA8_UNORM,      "SRGBA8_UNORM",      4,   1, FormatKind::kNormalized,   true,  true,  true,  true,  false, false, false, true  },
        { Format::SBGRA8_UNORM,      "SBGRA8_UNORM",      4,   1, FormatKind::kNormalized,   true,  true,  true,  true,  false, false, false, true  },
        ...
        { Format::RG16_SNORM,        "RG16_SNORM",        4,   1, FormatKind::kNormalized,   true,  true,  false, false, false, false, true,  false },
        ...
        { Format::RGBA16_SNORM,      "RGBA16_SNORM",      8,   1, FormatKind::kNormalized,   true,  true,  true,  true,  false, false, true,  false },
        ...
        { Format::BC4_SNORM,         "BC4_SNORM",         8,   4, FormatKind::kNormalized,   true,  false, false, false, false, false, true,  false },
        { Format::BC5_UNORM,         "BC5_UNORM",         16,  4, FormatKind::kNormalized,   true,  true,  false, false, false, false, false, false },
        { Format::BC5_SNORM,         "BC5_SNORM",         16,  4, FormatKind::kNormalized,   true,  true,  false, false, false, false, true,  false },
	...
	{
		static_assert(
			sizeof(c_FormatInfo) / sizeof(FormatInfo) == size_t(Format::COUNT),
