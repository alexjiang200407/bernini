...
| `.bmaterial` | Factors, the baked triplet, the per-channel routing table -- or, under `shadingModel: "pbrSurface"`, the surface it names and the parameters and textures it sets on it ([Game Surfaces](game_surfaces.md)) |
