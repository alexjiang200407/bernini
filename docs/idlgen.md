...
| `public static const` | [Constants.slang](libs/bgl/idl/src/Constants.slang) | `constexpr <type> = <expr>` | RHS copied verbatim, except that a `float` gains an `f` suffix; `public` needed for shader import. |
