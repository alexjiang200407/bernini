...
libs/bgl_common/shaders/src/          what every renderer shares; names no buffer, texture or handle
  ...
  lib/  anim/ math/ geom/ data/       the pose walk and vertex blend; the BRDF and its LUT integral, TAA's math, hashed alpha, tonemapping, a motion vector, a frustum test; vertex decode; plain view structs
