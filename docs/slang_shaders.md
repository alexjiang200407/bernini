...
[`lib/types/ComputeBuffer.slang`](../libs/bgl/shaders/src/lib/types/ComputeBuffer.slang)), the atomic
counterpart of `ComputeBuffer<T>`. The debug record buffer
([`lib/debug/dbg.slang`](../libs/bgl/shaders/src/lib/debug/dbg.slang)) is the worked example.
...
`RawBuffer` ([lib/types/RawBuffer.slang](../libs/bgl/shaders/src/lib/types/RawBuffer.slang)) wraps
...
`RawHandleView<T>` ([lib/types/RawHandleView.slang](../libs/bgl/shaders/src/lib/types/RawHandleView.slang))
...
[lib/types/Texture.slang](../libs/bgl/shaders/src/lib/types/Texture.slang) — `Load(uint2, uint)`,
...
([lib/types/HandleElement.slang](../libs/bgl/shaders/src/lib/types/HandleElement.slang)) is the one-field
