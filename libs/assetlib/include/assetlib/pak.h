...
{
	/**
	 * The `.bpak` archive: what writes one, what reads one back as a mount, and what a pack
	 * of a project reports. `AssetStore::Pack` is the door -- these are the format it moves
	 * through and the shape of what it says afterwards.
	 */
	...
	public:
		 ...
		 * therefore belong to a caller that adds in a fixed order, which is what AssetStore::Pack does.
		 *
