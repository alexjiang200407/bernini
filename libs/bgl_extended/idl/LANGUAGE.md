...
We copy all files in libs/bgl_extended/idl to libs/bgl_extended/shaders/idl but add a comment

```slang
// THIS IS A FILE GENERATED FROM libs/bgl_extended/idl/A.idl. DO NOT EDIT MANUALLY
