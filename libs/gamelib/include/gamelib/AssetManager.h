...
namespace game
{
	 ...
	 * which expands to its four route sources in place. Last, whatever the model, the UV1 occlusion
	 * map. Unrouted slots and channels, and an absent map, come back as empty strings, so the result
	 * is positional.
	 *
